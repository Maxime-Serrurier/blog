...
function ManageArticle(props) {
    ...
    const [inputs, setInputs] = useState({
        titre: {
            ...
            touched: false, 
            errorMessage: "Le titre doit contenir entre 5 et 85 caractères."
        },
        accroche: {
            ...
            touched: false,
            errorMessage: "L'accroche ne doit pas être vide et doit être comprise entre 10 et 140 caratères."
        },
        contenu: {
            elementType: 'textarea',
            elementConfig: {},
        ...
        auteur: {
            ...
            touched: false,
            errorMessage: "Il doit y avoir un auteur."
         },
        brouillon: {
            elementType: 'select',
            elementConfig: {
